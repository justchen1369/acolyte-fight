    ...
    render() {
        ...
        return <div>
            ...
            <p>
                ...
                {Hero.DamageBonusProportion && `Acolytes become more dangerous as they do more damage. Every 1% of damage you deal increases your damage output and knockback by ${Hero.DamageBonusProportion * 100}%. `}
