...
class ModdingPanel extends React.Component<Props, State> {
    ...
    render() {
        return <div>
            ...
            <h2>Create mod party</h2>
            <p>Mods can only be played within a mod party. If you don't make your party private, you will also be matched with other parties who happen to be playing the same mod.</p>
            ...
            <p><div className={this.state.selectedFile ? "btn" : "btn btn-disabled"} onClick={() => this.onSubmit()}>Create mod party</div></p>
