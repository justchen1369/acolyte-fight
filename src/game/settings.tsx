...
const retractor: Spell = {
    ...
    releaseBehaviours: [
        {
            ...
            targetType: "cursor",
            newSpeed: 0.1,
            revolutionsPerSecond: 1 / 20,
            maxTicks: 20,
            expireWithinRevs: 0.01,
        },
    ],
    ...
    projectile: {
        ...
        renderers: [
            ...
            { type: "ray", ticks: 10, glow: 0.2, vanish: 0.25, selfColor: true },
            { type: "strike", ticks: 10, glow: true, numParticles: 9, selfColor: true },
        ],
    },
};
...
const grapple: Spell = {
    ...
    projectile: {
        ...
        link: {
            ...
            sidewaysImpulsePerTick: 0.000014,
            minDistance: 0.025,
            maxDistance: 0.075,
