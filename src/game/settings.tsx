...
const halo: Spell = {
    id: 'halo',
    name: 'Halo',
    description: "Build up to 3 charges of your halo, then touch your enemy to lifesteal. Watch out, you lose 2 halos when hit, so keep dodging!",
    action: "projectile",
