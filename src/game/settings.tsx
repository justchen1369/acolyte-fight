...
const blast: Spell = {
    id: 'blast',
    name: 'Acolyte Blast',
    description: "Hold down the button to charge your blast for longer. Charge for 3 seconds for maximum damage and knockback. Just don't get interrupted while charging!",
    action: "charge",
...
const rocket: Spell = {
    id: 'rocket',
    name: 'Spirit Missile',
    description: "You control Spirit Missile while it is flying, but while doing this, you cannot move. Enemies hit will be unable to move for a short time. Cast Spirit Missile again to detonate it at exactly the right moment.",
    action: "focus",
...
const halo: Spell = {
    ...
    projectile: {
        ...
        color: '#ccc',
        renderers: [
            { type: "ray", selfColor: true, ownerColor: true, ticks: 15, glow: 0 },
